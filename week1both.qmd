...
- Assignment for next week (due one week from today):
  ...
  - You can find the assignment [here](https://github.com/JoshMerfeld/applied-microeconometrics/blob/main/assignments/assignment1/assignment1.pdf) (on the [course GitHub page](https://github.com/JoshMerfeld/applied-microeconometrics))
