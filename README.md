...
- Week 1: You can find the slides for the the week [Day 1 slides](https://joshmerfeld.github.io/geospatialdataR/week1both.html).
  - You can find the data for week 1 in the week1data folder or by clicking [here](week1data/data.csv) (you can download the csv in the upper-right-hand corner).
- Week 2: TBD
- Week 3: TBD
- Week 4: TBD
- Week 5: TBD
